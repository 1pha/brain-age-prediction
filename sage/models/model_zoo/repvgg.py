...
class RepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=1, width_multiplier=None, override_groups_map=None, deploy=False, use_se=False):
...
def build_repvgg(name):
    ...
    model = RepVGG(num_blocks=[1, 2, 7, 1], num_classes=1,
                  width_multiplier=[0.6, 0.6, 0.6, 1.5], override_groups_map=None, deploy=False)
    return model
