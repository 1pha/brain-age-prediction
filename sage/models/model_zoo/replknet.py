...
class RepLKNetStage(nn.Module):
    def __init__(
        ...
        if norm_intermediate_features:
            self.norm = get_bn(
                channels
            )  #   Only use this with RepLKNet-XL on downstream tasks
        else:
