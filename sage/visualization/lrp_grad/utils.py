...
def layers_lookup() -> dict:
    ...
    lookup_table = {
        ...
        torch.nn.modules.conv.Conv3d: RelevancePropagationConv3d,
        ...
        torch.nn.modules.pooling.MaxPool3d: RelevancePropagationMaxPool3d,
        torch.nn.modules.pooling.AdaptiveAvgPool2d: RelevancePropagationAdaptiveAvgPool2d,
        torch.nn.modules.pooling.AdaptiveAvgPool3d: RelevancePropagationAdaptiveAvgPool3d,
        torch.nn.AdaptiveAvgPool3d: RelevancePropagationAdaptiveAvgPool3d,
        "wildcard": RelevancePropagationIdentity,
    }
    return lookup_table
